  ...
  return (
    <nav className="w-full py-4 md:py-5 px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 md:gap-1 w-full md:w-auto">
        ...
        <Link to="/consultation" className="flex items-center gap-1 text-foreground/90 text-sm md:text-base px-3 md:px-4 py-2 rounded-lg hover:bg-white/5 transition-colors text-emerald-300 font-medium">
          Consultation
        </Link>
